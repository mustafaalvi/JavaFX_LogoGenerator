...
public class ToDoSelectionFoolproofDesign implements FoolproofDesign {
    ...
    public void updateControls() {
        ...
        gui.getGUINode(TDLM_MOVE_UP_ITEM_BUTTON).setDisable  ((!(itemIsSelected || itemsAreSelected)) || data.isSelectedAtTop());
        gui.getGUINode(TDLM_MOVE_DOWN_ITEM_BUTTON).setDisable((!(itemIsSelected || itemsAreSelected)) || data.isSelectedAtBottom());
