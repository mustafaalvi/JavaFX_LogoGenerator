...
public class ToDoWorkspace extends AppWorkspaceComponent {
	...
	VBox toDoListPane           = tdlBuilder.buildVBox(TDLM_PANE,               null,           null,   CLASS_TDLM_BOX, HAS_KEY_HANDLER,             FOCUS_TRAVERSABLE,      ENABLED);
        ...
        HBox listNamePane              = tdlBuilder.buildHBox(TDLM_OWNER_PANE,         nameOwnerPane,    null,   CLASS_TDLM_BOX, HAS_KEY_HANDLER,             FOCUS_TRAVERSABLE,      ENABLED);
        Label listNameLabel            = tdlBuilder.buildLabel(TDLM_NAME_LABEL,        listNamePane,      null,   CLASS_TDLM_PROMPT, HAS_KEY_HANDLER,           FOCUS_TRAVERSABLE,      ENABLED);
        TextField listNameTextField    = tdlBuilder.buildTextField(TDLM_LIST_NAME_TEXT_FIELD,   listNamePane,      null,   CLASS_TDLM_TEXT_FIELD, NO_KEY_HANDLER,       FOCUS_TRAVERSABLE,      ENABLED);
        ...
        Button moveUpItemButton     = tdlBuilder.buildIconButton(TDLM_MOVE_UP_ITEM_BUTTON,   itemButtonsPane,    null,   CLASS_TDLM_BUTTON, HAS_KEY_HANDLER,   FOCUS_TRAVERSABLE,  DISABLED);
        Button moveDownItemButton     = tdlBuilder.buildIconButton(TDLM_MOVE_DOWN_ITEM_BUTTON,   itemButtonsPane,    null,   CLASS_TDLM_BUTTON, HAS_KEY_HANDLER,   FOCUS_TRAVERSABLE,  DISABLED);
	...
	((BorderPane)workspace).setCenter(toDoListPane);
        ...
        listNameTextField.textProperty().addListener(e->{
            app.getFileModule().markAsEdited(true);
        });
        ...
        itemsTable.setOnMouseClicked(e -> {
            ...
            if((e.getClickCount() == 2) && data.isItemSelected())
                itemsController.processEditItems();
