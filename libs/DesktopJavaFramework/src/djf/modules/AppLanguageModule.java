...
public class AppLanguageModule {
    ...
    public void loadLanguageSettings(String initLanguage) throws LanguageException {
        ...
        try {
            ...
            resetLanguage(); //takes all labeled controlled props and load them
    ...
    public void init() throws LanguageException {
        try {
            ...
            for (String languageName : languageNames) {
                ...
                this.languageCodes.put(languageName, abbreviation); //Maps English to EN, etc. etc. 
            }
    ...
    public void resetLanguage() throws LanguageException {
        ...
        for (String propertyKey : labeledControlProperties.keySet()) {
            StringProperty property = labeledControlProperties.get(propertyKey); //a control property in OG language
            String text = props.getProperty(propertyKey); // same property but in newLanguage 
            property.setValue(text); //setting the property to the newLanguage
        }
    } //buttons havent been loaded here yet 

    public void setCurrentLanguage(String initCurrentLanguage) throws LanguageException {
        //     String langCode = languageCodes.get(initCurrentLanguage);
