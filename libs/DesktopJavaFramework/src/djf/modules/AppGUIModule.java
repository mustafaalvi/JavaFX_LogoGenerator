...
public class AppGUIModule {
    ...
    public void loadGUI(Stage initPrimaryStage) throws LanguageException {
        ...
        // THIS WILL STORE ALL OF OUR APP NODES ids are kept in two places (AppPropertyTypes and ToDoPropertyType)
        guiNodes = new HashMap();

        // THIS WILL BUILD ALL THE NODES and register them with the modules
