...
import static djf.AppPropertyType.LOAD_ERROR_NULL_CONTENT;
import static djf.AppPropertyType.LOAD_ERROR_NULL_TITLE;
        ...
        while (it.hasNext()) {
            ...
            workButton.setOnAction(e -> {
                ...
                try {
                    ...
                    AppDialogsFacade.showMessageDialog(app.getGUIModule().getWindow(), LOAD_ERROR_NULL_TITLE, LOAD_ERROR_NULL_CONTENT);
                    this.hide();
                    app.getGUIModule().getWindow().show();
                }
            });
